...
export const faqsFr = [
  ...
  ["Les photos sont-elles privées ?", "La galerie de l'événement n'est pas indexée publiquement et reste accessible uniquement via un lien imprévisible ou le QR code. Elle n'est pas protégée par mot de passe : ne partagez donc le lien qu'avec vos invités. L'organisateur peut à tout moment masquer toute la galerie ou une photo."],
