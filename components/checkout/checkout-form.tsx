...
const CHECKOUT_COPY = {
  sl: {
    ...
    fullName: "Ime in priimek", namePlaceholder: "npr. Nina Novak", email: "E-pošta", emailPlaceholder: "ime@podjetje.si",
  ...
  en: {
    ...
    fullName: "Full name", namePlaceholder: "e.g. Emily Smith", email: "Email", emailPlaceholder: "emily@willowevents.co.uk",
    ...
    eventName: "Event name", eventPlaceholder: "e.g. Emily and James's wedding", location: "Location", optional: "optional",
    locationPlaceholder: "e.g. The Orangery", start: "Start", end: "End",
  ...
  de: {
    ...
    fullName: "Vor- und Nachname", namePlaceholder: "z. B. Lena Müller", email: "E-Mail", emailPlaceholder: "lena@nordlicht.de",
    ...
    eventName: "Name des Events", eventPlaceholder: "z. B. Hochzeit von Lena und Jonas", location: "Ort", optional: "optional",
    locationPlaceholder: "z. B. Schloss Charlottenburg", start: "Beginn", end: "Ende",
  ...
  nl: {
    ...
    fullName: "Volledige naam", namePlaceholder: "bijv. Sophie de Vries", email: "E-mail", emailPlaceholder: "sophie@studionoord.nl",
    ...
    eventName: "Naam van het evenement", eventPlaceholder: "bijv. Bruiloft van Sophie en Daan", location: "Locatie", optional: "optioneel",
    locationPlaceholder: "bijv. Kasteel De Haar", start: "Begin", end: "Einde",
  ...
  es: {
    ...
    fullName: "Nombre y apellidos", namePlaceholder: "p. ej. Lucía García", email: "Correo electrónico", emailPlaceholder: "lucia@estudionorte.es",
    ...
    eventName: "Nombre del evento", eventPlaceholder: "p. ej. Boda de Lucía y Mateo", location: "Lugar", optional: "opcional",
    locationPlaceholder: "p. ej. Finca El Olivar", start: "Inicio", end: "Fin",
  ...
  it: {
    ...
    fullName: "Nome e cognome", namePlaceholder: "es. Giulia Rossi", email: "E-mail", emailPlaceholder: "giulia@studioaurora.it",
    ...
    eventName: "Nome dell'evento", eventPlaceholder: "es. Matrimonio di Giulia e Marco", location: "Luogo", optional: "facoltativo",
    locationPlaceholder: "es. Villa del Balbianello", start: "Inizio", end: "Fine",
  ...
  fr: {
    ...
    fullName: "Nom et prénom", namePlaceholder: "p. ex. Camille Dupont", email: "E-mail", emailPlaceholder: "camille@atelierlumiere.fr",
    ...
    eventName: "Nom de l'événement", eventPlaceholder: "p. ex. Mariage de Camille et Louis", location: "Lieu", optional: "facultatif",
    locationPlaceholder: "p. ex. Château de Vaux-le-Vicomte", start: "Début", end: "Fin",
