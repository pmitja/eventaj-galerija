...
const CHECKOUT_COPY = {
  sl: {
    ...
    zip: "ZIP po zaključku dogodka", aiNote: "Samodejni izbor do 3.000 fotografij.", face: "Iskanje fotografij po obrazu",
    faceNote: "Gostje s selfijem najdejo svoje fotografije.", unlimitedVideos: "Neomejeno videov",
    videoNote: "Do 60 sekund in 500 MB na video. Velja pravilo razumne uporabe do 1.000 videov.", total: "Skupaj", tax: "Cena vključuje DDV.",
  ...
  en: {
    ...
    zip: "ZIP after the event", aiNote: "Automatic selection for up to 3,000 photos.", face: "Photo search by face",
    faceNote: "Guests use a selfie to find their photos.", unlimitedVideos: "Unlimited videos",
    videoNote: "Up to 60 seconds and 500 MB per video. Fair-use cap of 1,000 videos.", total: "Total", tax: "VAT included.",
  ...
  de: {
    ...
    zip: "ZIP nach dem Event", aiNote: "Automatische Auswahl für bis zu 3.000 Fotos.", face: "Fotosuche per Gesicht",
    faceNote: "Gäste finden ihre Fotos per Selfie.", unlimitedVideos: "Unbegrenzt Videos",
    videoNote: "Bis zu 60 Sekunden und 500 MB pro Video. Fair-Use-Grenze: 1.000 Videos.", total: "Gesamt", tax: "Inkl. MwSt.",
  ...
  nl: {
    ...
    zip: "ZIP na het evenement", aiNote: "Automatische selectie voor maximaal 3.000 foto's.", face: "Foto's zoeken op gezicht",
    faceNote: "Gasten vinden hun foto's met een selfie.", unlimitedVideos: "Onbeperkt video's",
    videoNote: "Tot 60 seconden en 500 MB per video. Fair-usegrens van 1.000 video's.", total: "Totaal", tax: "Inclusief btw.",
  ...
  es: {
    ...
    zip: "ZIP al terminar el evento", aiNote: "Selección automática para hasta 3.000 fotos.", face: "Búsqueda de fotos por rostro",
    faceNote: "Los invitados encuentran sus fotos con un selfi.", unlimitedVideos: "Vídeos ilimitados",
    videoNote: "Hasta 60 segundos y 500 MB por vídeo. Tope de uso razonable: 1.000 vídeos.", total: "Total", tax: "IVA incluido.",
  ...
  it: {
    ...
    zip: "ZIP al termine dell'evento", aiNote: "Selezione automatica fino a 3.000 foto.", face: "Ricerca foto per volto",
    faceNote: "Gli ospiti trovano le loro foto con un selfie.", unlimitedVideos: "Video illimitati",
    videoNote: "Fino a 60 secondi e 500 MB per video. Tetto di uso corretto: 1.000 video.", total: "Totale", tax: "IVA inclusa.",
  ...
  fr: {
    ...
    zip: "ZIP après l'événement", aiNote: "Sélection automatique jusqu'à 3 000 photos.", face: "Recherche de photos par visage",
    faceNote: "Vos invités retrouvent leurs photos avec un selfie.", unlimitedVideos: "Vidéos illimitées",
    videoNote: "Jusqu'à 60 secondes et 500 Mo par vidéo. Plafond d'usage raisonnable : 1 000 vidéos.", total: "Total", tax: "TVA incluse.",
