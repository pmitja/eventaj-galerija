...
export const nl: Dictionary = {
  ...
  useCases: {
    ...
    subtitle:
      "Eén QR-galerij voor bruiloften, verjaardagen, bedrijfsfeesten en teamdagen.",
    readMore: "Lees meer",
  },
  useCasePage: {
  ...
  features: {
    ...
    subtitleDesktop:
      "Foto's, korte video's en spraakberichten van al je gasten, verzameld in één galerij.",
  ...
  guest: {
    ...
    live: {
      ...
      milestoneOutstanding: "Dat zijn veel foto's voor één avond.",
    ...
    voice: {
      ...
      guestbookHeading: "In hun eigen stem",
      ...
      emptyList: "Nog geen spraakberichten. Laat het eerste bericht achter.",
      guest: "Gast",
    ...
    gallery: {
      ...
      share: "Galerij delen",
      welcome:
        "Welkom in de gedeelde galerij. Voeg je eigen momenten toe, zodat de anderen ze ook zien.",
      ...
      voiceHeading: "In hun eigen stem",
  ...
  order: {
    ...
    intro:
      "Vul alleen je e-mailadres in en betaal veilig via Stripe. Daarna voeg je de evenementgegevens toe via een persoonlijke link.",
