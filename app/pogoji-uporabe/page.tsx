...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: locale === "en" ? "Terms of Use | Eventaj Gallery" : "Pogoji uporabe | Eventaj Galerija", robots: { index: true, follow: true } };
}
...
export default async function TermsPage() {
  ...
  return <main className={styles.page}>
    ...
    <article className={styles.article}>
      ...
      <h2>7. Contact</h2><p>For questions, content reports or deletion requests, email <a href="mailto:info@eventaj.si">info@eventaj.si</a>. Details about personal data processing are in the <Link href="/zasebnost">Privacy Policy</Link>.</p>
      </> : <>
